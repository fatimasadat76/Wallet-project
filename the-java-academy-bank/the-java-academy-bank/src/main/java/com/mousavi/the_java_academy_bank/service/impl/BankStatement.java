...
public class BankStatement {
    ...
    private static final String FILE ="C:\\Users\\Admin\\Document\\MyDocument.pdf";
    /**
     * retriev list of transaction within a date range given an account number
    ...
    public List<Transaction> generateStatement(String accountNumber,String startDate,String endDate) throws FileNotFoundException, DocumentException {
        ...
        List<Transaction> transactionList = transactionRepository.findAll().stream()
                ...
                .filter(transaction -> Objects.equals(transaction.getCreatedAt(), start))
                .filter(transaction -> Objects.equals(transaction.getCreatedAt(), end)).toList();
        ...
        PdfPCell bankAddress = new PdfPCell(new Phrase("72 , Some Address"));
        bankName.setBorder(0);
